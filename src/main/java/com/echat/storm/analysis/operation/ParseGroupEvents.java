...
public class ParseGroupEvents extends BaseFunction {
	private static final Logger log = LoggerFactory.getLogger(ParseGroupEvents.class);
	...
	public void execute(TridentTuple tuple, TridentCollector collector) {
		...
		if( ev != null && content != null ) {
			...
			if( uid != null && gid != null ) {
				collector.emit(new Values(uid,gid));
			}
		}
	}
}
