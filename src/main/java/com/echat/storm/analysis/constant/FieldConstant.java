...
public class FieldConstant {
	public static final String SERVER_FIELD = "svc";
	...
	public static final String DEVICE_FIELD = "dev";
	public static final String DEVICE_ID_FIELD = "dev-id";
	public static final String IMSI_FIELD = "imsi";
	public static final String EXPECT_PAYLOAD_FIELD = "ex-pt";
	public static final String RESULT_FIELD = "result";
	public static final String TARGET_FIELD = "tar";
